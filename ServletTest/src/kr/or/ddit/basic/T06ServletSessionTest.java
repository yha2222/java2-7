...
/*
	 	...
	 	boolean값 : true인 경우 => 세션 객체가 존재하지 않으면 새로 생성 : 이전에 한번이라고 있으면 갖고 오고 없으면 만들어서 던져줌, 사용 하든 안하든 무조건 만듦
	 			   false인 경우 => 세션 객체가 존재하지 않으면 null을 리턴 :
	 	- 세션 삭제 처리 방법
	 	1. invalidate() 메서드 호출
...
*/
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//session.invalidate(); // 세션 삭제(1. 무효화 처리 - 당장!!)
		session.setMaxInactiveInterval(30); // 세션 삭제(2. )
